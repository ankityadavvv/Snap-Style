import type { NeemanShoe, ExampleScenario } from "@shared/schema";
...
export const neemansShoes: NeemanShoe[] = [
  ...
  { id: "tread-basics-white", name: "Tread Basics : White", price: 999, materials: ["Recycled Plastic"], colors: ["White"], categories: ["casual", "formal"], imageUrl: "https://neemans.com/cdn/shop/files/White_899dcdcb-d714-4157-bf93-8b37d8e10348.png?v=1724986956&width=800", productUrl: "https://neemans.com/products/tread-basics-white", description: "Clean white sneaker perfect for all occasions." },
  ...
  { id: "begin-walk-breeze-ivory", name: "Begin Walk Breeze : Ivory", price: 2099, materials: ["Knit Fabric", "Recycled Plastic"], colors: ["Ivory"], categories: ["casual", "walking"], imageUrl: "https://neemans.com/cdn/shop/files/Ivory_6b0793c2-d6f4-4d1b-9ba7-ea38ab1b8b63.png?v=1747398883&width=800", productUrl: "https://neemans.com/products/begin-walk-breeze", description: "Lightweight and breathable for easy walking." },
  ...
  { id: "begin-walk-trek", name: "Begin Walk Trek : Ivory Brown", price: 2099, materials: ["Knit Fabric", "Recycled Plastic"], colors: ["Brown"], categories: ["casual", "walking", "outdoor"], imageUrl: "https://neemans.com/cdn/shop/files/Ivory-Brown_84b428b1-b90b-49b3-a36e-1c3dc47d170b.png?v=1756451590&width=800", productUrl: "https://neemans.com/products/begin-walk-trek", description: "Perfect for trekking and outdoor adventures." },
  { id: "begin-walk-glide", name: "Begin Walk Glide : Teal", price: 2099, materials: ["Knit Fabric", "Recycled Plastic"], colors: ["Teal"], categories: ["casual", "walking"], imageUrl: "https://neemans.com/cdn/shop/files/Teal.png?v=1763982313&width=800", productUrl: "https://neemans.com/products/begin-walk-glide", description: "Stylish teal sneaker with superior comfort." },
  { id: "begin-walk-flames", name: "Begin Walk Flames For Men : Grey", price: 3499, materials: ["Premium Knit", "Recycled Plastic"], colors: ["Grey"], categories: ["casual", "walking"], imageUrl: "https://neemans.com/cdn/shop/files/Grey_004a4877-fe69-4815-822c-a104f689f133.png?v=1761808287&width=800", productUrl: "https://neemans.com/products/begin-walk-flames-for-men-grey", description: "Premium walking shoe with advanced comfort technology." },
  ...
  { id: "knit-gliders-olive", name: "Knit Gliders : Olive", price: 1999, materials: ["Knit Fabric", "Recycled Plastic"], colors: ["Olive"], categories: ["casual", "athleisure"], imageUrl: "https://neemans.com/cdn/shop/files/Olive_421d75fd-ff5c-4552-9b99-2f52def2b2eb.png?v=1756358865&width=800", productUrl: "https://neemans.com/products/knit-gliders-olive", description: "Trendy olive color with maximum comfort." },
  ...
  { id: "knit-trainers-for-men", name: "Knit Trainers For Men : Ivory Brown", price: 1799, materials: ["Knit Fabric", "Recycled Plastic"], colors: ["Brown"], categories: ["casual", "athleisure", "walking"], imageUrl: "https://neemans.com/cdn/shop/files/Ivory_Brown_cafa2ef7-e6aa-4680-9101-3f2d72957f28.png?v=1761807709&width=800", productUrl: "https://neemans.com/products/knit-trainers-for-men", description: "Premium training shoe for active use." },
  ...
  { id: "the-dependables", name: "The Dependables : Black-Blue", price: 1399, materials: ["Recycled Plastic", "Cotton Knit"], colors: ["Black", "Blue"], categories: ["casual", "walking"], imageUrl: "https://neemans.com/cdn/shop/files/Black-Blue.png?v=1725023388&width=800", productUrl: "https://neemans.com/products/the-dependables", description: "Reliable everyday sneaker for all seasons." },
  ...
  { id: "everyday-basic-slip-ons", name: "Everyday Basic Slip Ons : Neon Navy", price: 1049, materials: ["Recycled Plastic"], colors: ["Navy"], categories: ["casual", "walking"], imageUrl: "https://neemans.com/cdn/shop/files/Black-Blue.png?v=1725023388&width=800", productUrl: "https://neemans.com/products/everyday-basic-slip-ons", description: "Affordable everyday slip-ons for casual wear." },
  ...
  { id: "knit-grace-loafers-pink", name: "Knit Grace Loafers : Pink", price: 2099, materials: ["Knit Fabric"], colors: ["Pink"], categories: ["casual", "office"], imageUrl: "https://neemans.com/cdn/shop/files/Extra_Honey_f1c1864b-1e1e-416d-84ca-ad6d3450d709.png?v=1743678165&width=800", productUrl: "https://neemans.com/products/knit-grace-loafers", description: "Feminine loafers in elegant pink color." },
